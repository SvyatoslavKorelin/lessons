# encoding=utf-8
class Hero:
    def unit_(self, name, health, armor, power, weapon, rank):
        self.name = name
        self.health = health
        self.armor = armor
        self.power = power
    ...
    def set_rank(self):
        newrank = input()
        self.__rank = newrank
        print('Звание изменено. Новое звание: ' + str(self.__rank))

    def delete_rank(self):
        self.__rank = None
        print('Звание удалено')

    def get_rank(self):
        print('Ранг персонажа ' + str(self.__rank))

    def strike(self, enemy):
        while self.health > 0 and enemy.health > 0:
            print('-> УДАР' + self.name + 'атакует' + enemy.game + 'с силой' + str(self.power) + 'б используя' + self.weapon +'\n')
